...
// CRITICAL: This MUST be the default export for the Next.js build to pass
export default function Home() {
  ...
  const generateMark = async () => {
    ...
    try {
      ...
      for (let l = 0; l < 12; l++) {
        // Guaranteed all 4 logos are used in the first 4 layers
        const layerImg = l < 4 ? imgs[l] : imgs[Math.floor(Math.random() * 4)];
        
        // Locked low-fold symmetry for "Badge" feel
  ...
  return (
    <div style={{ backgroundColor: '#000', minHeight: '100vh', padding: '20px', color: '#FFF', fontFamily: 'monospace' }}>
      <Head><title>BRAND_PLAYBOOK_V2.1.1</title></Head>
      ...
      <div style={{ maxWidth: '850px', margin: '0 auto', border: '1px solid #FFF', padding: '25px' }}>
        {!generatedImg ? (
          <>
            <h1 style={{ fontSize: '1.2rem', letterSpacing: '2px', borderBottom: '1px solid #FFF', paddingBottom: '10px' }}>EMBLEM_SYNTHESIS_PRO</h1>
          ...
          <div style={{ textAlign: 'center' }}>
            <img src={generatedImg} style={{ width: '100%', border: '1px solid #FFF' }} alt="Generated Emblem" />
